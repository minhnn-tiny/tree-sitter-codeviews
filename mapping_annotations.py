...
# Loading original annotations ========================================================
    ...
    # org_annotation_buggy = '/Users/minh/Documents/2022/smart_contract/mando/original-ge-sc/data/solidifi_buggy_contracts/access_control/vulnerabilities.json'
...
# Get source codes ========================================================
    ...
    # source_dir = '/Users/minh/Documents/2022/smart_contract/mando/original-ge-sc/experiments/ge-sc-data/source_code/access_control/buggy_curated'
    # cleaned_source_dir = '/Users/minh/Documents/2022/smart_contract/mando/original-ge-sc/experiments/ge-sc-data/source_code/access_control/cleaned_buggy_curated'
...
#==========================================================================
        ...
        for vul in vuls:
            ...
            for l in lines:
                ...
                for ln, code in cleaned_src_locations.items():
                    if code.rstrip() == org_code.rstrip() and ln > current_line and org_code.rstrip() != "":
                        # print(ln)
                        # print(code.rstrip())
    ...
    # cleaned_annotation_output = '/Users/minh/Documents/2022/smart_contract/mando/original-ge-sc/experiments/ge-sc-data/source_code/access_control/cleaned_buggy_curated/vulnerabilities.json'
