...
class DFGGraph_solidity(DFGGraph):
    def __init__(self, src_language, src_code, properties, root_node, parser):
        ...
        _,self.node_list,self.graph_node_list,_ = solidity_nodes.get_nodes(root_node = self.root_node, node_list = {}, graph_node_list = [], index = self.index, records = self.records, statement_types = self.statement_types)
